...
makeRLearner.classif.xgboost.custom.loss.function = function() {
  makeRLearnerClassif(
    cl = "classif.xgboost.custom.loss.function",
    package = "xgboost",
...
#' @export
trainLearner.classif.xgboost.custom.loss.function = function(.learner, .task, .subset, .weights = NULL, ...) {
...
#' @export
predictLearner.classif.xgboost.custom.loss.function = function(.learner, .model, .newdata, ...) {
...
#' @export
getFeatureImportanceLearner.classif.xgboost.custom.loss.function = function(.learner, .model, ...) {
...
registerS3method("makeRLearner", "classif.xgboost.custom.loss.function", 
                 makeRLearner.classif.xgboost.custom.loss.function)
registerS3method("trainLearner", "classif.xgboost.custom.loss.function", 
                 trainLearner.classif.xgboost.custom.loss.function)
registerS3method("predictLearner", "classif.xgboost.custom.loss.function", 
                 predictLearner.classif.xgboost.custom.loss.function)
registerS3method("getFeatureImportanceLearner", "classif.xgboost.custom.loss.function", 
                 getFeatureImportanceLearner.classif.xgboost.custom.loss.function)
